...
import { buttonVariants } from '@trinserhof/ui';
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell: 'text-base-content/60 rounded-md w-8 font-normal text-[0.8rem]',
        ...
        day: cn(
          ...
          'relative h-10 w-8 p-0 font-normal aria-selected:opacity-100',
        ),
        ...
        day_outside:
          'day-outside text-base-content/60 opacity-50  aria-selected:bg-accent/50 aria-selected:text-base-content/60 aria-selected:opacity-30',
        day_disabled: 'text-base-content/60 opacity-50',
